...
The EmailTemplates microservice can also be used as a Seneca plugin.
...
```javascript
{
    ...
    "dependencies": {
        ....
        "pip-services-emailtemplates-node": "^1.1.*",
        ...
    }
}
```
...
var config = {
    ...
    persistence: {
        type: 'file'
        path: 'emailtemplates.json'
    }
};

var plugin = new require('pip-services-emailtemplates-node').EmailTemplatesSenecaPlugin;
...
or by using [EmailTemplatesSenecaClient](https://github.com/pip-services-content/pip-clients-emailtemplates-node/doc/NodeClientApiV1.md/#client_seneca)