...
export interface IEmailTemplatesPersistence extends IGetter<EmailTemplateV1, string>, IWriter<EmailTemplateV1, string> {
    ...
    getOneById(correlationId: string, id: string, callback: (err: any, item: EmailTemplateV1) => void): void;
    getOneByIdOrName(correlationId: string, idOrName: string, callback: (err: any, item: EmailTemplateV1) => void): void;
    create(correlationId: string, item: EmailTemplateV1, callback: (err: any, item: EmailTemplateV1) => void): void;
    update(correlationId: string, item: EmailTemplateV1, callback: (err: any, item: EmailTemplateV1) => void): void;
    deleteById(correlationId: string, id: string, callback: (err: any, item: EmailTemplateV1) => void): void;
}
